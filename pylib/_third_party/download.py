"""
This code is adapt from torchnlp.download
https://github.com/PetrochukM/PyTorch-NLP/blob/master/torchnlp/download.py
"""
import importlib
import types
import logging
...
def download_file_maybe_extract(url, directory, filename=None, extension=None, check_files=[]):
    """ Download the file at ``url`` to ``directory``. Extract to ``directory``
    Args:
