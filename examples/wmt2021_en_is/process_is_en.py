...
wmt2021_en_is_parallel = {
    "ParIce":
    "http://parice.arnastofnun.is/data/parice_filtered.zip",
    "ParaCrawl v7.1":
    ...
    "En-Is Semi-Synthetic Parallel Name Robustness Corpus":
    "https://repository.clarin.is/repository/xmlui/bitstream/handle/20.500.12537/74/parice-name-corpus.post-substitution.v2.tsv",
    "EN-IS Synthetic Parallel Corpus":
    "https://repository.clarin.is/repository/xmlui/bitstream/handle/20.500.12537/70/eng-isl-synthetic-corpus-v1.0.tar.gz"
}
...
@mtcorpus.download_warpper(wmt2021_en_is_parallel["ParIce"],
                           "is-en/raw/parice1.1.zip", "is-en/raw/ParIce1.1")
...
@mtcorpus.download_warpper(wmt2021_en_is_parallel["ParaCrawl v7.1"],
                           "is-en/raw/en-is.txt.gz", "is-en/raw/en-is.txt")
...
@mtcorpus.download_warpper(wmt2021_en_is_parallel["Wiki Titles v3"],
                           "is-en/raw/wikititles-v3.is-en.tsv",
                           "is-en/raw/wikititles-v3.is-en.tsv")
...
@mtcorpus.download_warpper(wmt2021_en_is_parallel["WikiMatrix"],
                           "is-en/raw/WikiMatrix.v1.en-is.langid.tsv",
                           "is-en/raw/WikiMatrix.v1.en-is.langid.tsv")
...
def get_paricename_corpus():
    ...
    print(
        "Processing En-is Semi-Synthetic Parallel Name Robustness Corpus done."
    )


@mtcorpus.download_warpper(
    wmt2021_en_is_parallel["EN-IS Synthetic Parallel Corpus"],
    "is-en/raw/eng-isl-synthetic-corpus-v1.0.tar.gz",
    "is-en/raw/eng-isl-synthetic-corpus-v1.0")
def get_paricesynthetic_corpus():
    ...
    mtcorpus.write_corpus("is-en/parallel/parices-synthetic", corpus, "en",
                          "is")
    print("Processing EN-IS Synthetic Parallel Corpus done.")


@mtcorpus.download_warpper(wmt2021_en_is_dev, "is-en/raw/dev.tgz",
                           "is-en/raw/dev")
def get_dev_corpus():
    print("Processing dev data ...")
    subprocess.call(
        "python is-en/raw/dev/dev/xml/extract.py is-en/raw/dev/dev/xml/newsdev2021.en-is.xml -o is-en/raw/dev/dev/newsdev2021.en-is",
        shell=True)
...
@mtcorpus.download_warpper(wmt2021_is_monolingual["News crawl"],
                           "is-en/raw/news.2020.is.shuffled.gz",
                           "is-en/raw/news.2020.is.shuffled")
def get_monolingual_newscrawl():
    print("Processing monolingual News crawl of is...")
    corpus = mtcorpus.monolingual_seperate_file_parser(
        ["is-en/raw/news.2020.is.shuffled"])
    mtcorpus.write_corpus("is-en/monolingual/newscrawl", corpus, "is")
    print("Process monolingual newscrawl is data done.")


@mtcorpus.download_warpper(wmt2021_is_monolingual["Common Crawl"],
                           "is-en/raw/is.deduped.xz", "is-en/raw/is.deduped")
def get_monolingual_commoncrawl():
    print("Processing monolingual Common Crawl of is")
    corpus = mtcorpus.monolingual_seperate_file_parser(
        ["is-en/raw/is.deduped"])
    mtcorpus.write_corpus("is-en/monolingual/commoncrawl", corpus, "is")
    print("Processing monolingual Common Crawl is data done.")


@mtcorpus.download_warpper(wmt2021_is_monolingual["Icelandic Gigaword Part1"],
                           "is-en/raw/", "is-en/raw/CC_BY")
...
def main():
    ...
    get_monolingual_icelandic_gigaword()
